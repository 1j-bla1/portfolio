...
### Summary of Contribution to the Team
I greatly helped our team complete our Mansion game by adding key elements such as music and the health bar for the boss. I fixed up and added any code that Anish and Sammarth weren't doing (They are really smart) so they had less on their plate to complete. I also made it to when you press the letter p the boss automatically dies so you don't have to fight the entire boss to make the end screen. This was extremely useful to see if the end screen worked or not.

I also did several fixes to code throughout the game to make it operational. This includes things such as adjusting the location of the player so he appears on screen, making the music disappear so different songs don't overlap, and causing the Boss health bar to disappear after he is defeated. I added the invisible sprite for our pre-battle room door so players could enter the battle room. I also added many different dialouge to one of zombies making our team more complete. 

In github I also did a lot of work on the Kanban board by creating tons of issues so our team could stay organized. I constantly updated this as we added things to out game. This is my contributions I made to our Mansion Game.
